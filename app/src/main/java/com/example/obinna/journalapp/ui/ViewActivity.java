                ...
                builder.setMessage("Delete this memory?")
                        .setPositiveButton("OK",new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                // Delete the data
                                String entryId = String.valueOf(mEntry.getId());
                                databaseReference.child("entries").child(userId).child(entryId)
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ViewActivity.this,"Could not delete.\nSome error occurred.",
                                                Toast.LENGTH_SHORT).show();
                                        Log.d("ViewActivity","Error message" + e.getMessage());
                                    }
                                });
                                onBackPressed();
                            }
